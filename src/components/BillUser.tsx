export default function BillUser({ status }: { status: string }) {
  const statusTypes: any = {
    pending: {
      ...
      message:
        "Please contact your Account manager to be able to gain full access on your personal trading account/portfolio",
    },
    "signal fee": {
  ...
  return (
    <div className="flex justify-center text-center text-bodydark1 bg-boxdark mb-16 py-8 px-5">
      <div>
        <div>
