  ...
  return (
    <header className="px-6 py-6 xl:hidden">
      ...
      >
        ...
        <li className="cursor-pointer relative " onClick={() => setIsMarketMenuOpen(!isMarketMenuOpen)}>
          <div className="hover:text-primary-hover font-medium text-lg">Market</div>

          <ul className={`px-4 flex flex-col gap-y-4 mt-5 ${isMarketMenuOpen ? "block" : "hidden"}`}>
            <li>
        ...
        <li className="relative " onClick={() => setIsPlatformMenuOpen(!isPlatformMenuOpen)}>
          <div className="font-medium text-lg hover:text-primary-hover cursor-pointer">Platform</div>
          <ul className={`px-4 flex flex-col gap-y-4 mt-5 ${isPlatformMenuOpen ? "block" : "hidden"}`}>
            <li>
